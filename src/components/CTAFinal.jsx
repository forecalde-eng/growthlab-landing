      ...
      <div className="section-wrap text-center relative z-10" style={{maxWidth:"48rem"}}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.5 }}>
          ...
          <a href={waLink} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-teal text-teal-dark font-semibold text-lg px-9 py-4 rounded-full hover:brightness-110 hover:scale-[1.02] transition-all duration-200">
          ...
          <p className="mt-6 text-xs text-text-dim">Respondemos en menos de 5 minutos</p>
        </motion.div>
      </div>
    </section>
  )
